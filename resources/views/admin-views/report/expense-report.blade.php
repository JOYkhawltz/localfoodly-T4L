...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="__page-header-txt mb-3 pt-3">
                <span>
                {{ translate('This report shows the delivery fee for all orders whose delivery fee is free for using "free delivery over" or "free delivery coupon.') }}
            </span>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="search--button-wrapper">
                            ...
                            @csrf
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch" name="search" type="search" class="form-control h--40px" placeholder="{{translate('Search by type or description')}}" aria-label="{{translate('messages.search_here')}}">
