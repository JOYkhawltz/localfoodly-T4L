                            ...
                            <div class="row g-3">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label  class="form-label text-capitalize">{{translate('messages.app_minimum_version')}} ({{translate('messages.android')}})
                                    ...
                                    <div class="form-group m-0">
                                        <label class="form-label text-capitalize">{{translate('messages.Download_Url')}} ({{translate('messages.android')}})</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label  class="form-label text-capitalize">{{translate('messages.app_minimum_version')}} ({{translate('messages.ios')}})
                                            <span class="input-label-secondary text--title" data-toggle="tooltip"
                                            data-placement="right"
                                            data-original-title="{{ translate('messages.app_min_version_hint') }}">
                                            <i class="tio-info-outined"></i>
                                    ...
                                    <div class="form-group m-0">
                                        <label class="form-label text-capitalize">{{translate('messages.Download_Url')}} ({{translate('messages.ios')}})</label>
