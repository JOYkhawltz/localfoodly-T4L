                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-sm-4 col-12">
                                    ...
                                    <div class="form-group">
                                        <label class="input-label d-inline">{{ translate('messages.scheduled') }}
                                            ...
                                            <!-- <span class="input-label-secondary" title="{{ translate('messages.customer_varification_toggle') }}"><img src="{{ asset('/assets/admin/img/info-circle.svg') }}" alt="{{ translate('messages.customer_varification_toggle') }}"></span> -->
                                            *
                                        </small>
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-xl-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize d-flex alig-items-center"><span class="line--limit-1">
                                            {{ translate('Restaurant Business Model') }}</span>
                                            <span class="input-label-secondary text--title" data-toggle="tooltip" data-placement="right"
                                            data-original-title="{{translate('This option will changes the Business Model to Subacription Package Based Model or Commission on Per Order Model or Both')}}">
                                            <i class="tio-info-outined"></i>
                                            </span></label>

                                            <div class="resturant-type-group border">
                                                <label class="form-check form--check mr-2 mr-md-4">
                                                    @php($checked = ($business_model['subscription'] == 0 &&  $business_model['commission'] == 1) ? 'checked' : '')
                                                    <input class="form-check-input" type="radio" name="business_model" id="check-veg" {{$checked}} value="commission">
                                                    <span class="form-check-label">
                                                        {{translate('messages.Commission')}}
                                                    </span>
                                                </label>
                                                <label class="form-check form--check mr-2 mr-md-4">
                                                    @php($checked = ($business_model['subscription'] == 1 &&  $business_model['commission'] == 0) ? 'checked' : '')
                                                    <input class="form-check-input" type="radio" name="business_model" id="check-non-veg" {{$checked}} value="subscription">
                                                    <span class="form-check-label">
                                                        {{translate('messages.Subscription')}}
                                                    </span>
                                                </label>
                                                <label class="form-check form--check">
                                                    @php($checked = ($business_model['subscription'] == 1 &&  $business_model['commission'] == 1) ? 'checked' : '')
                                                    <input class="form-check-input" type="radio" name="business_model" id="check-both" {{$checked}} value="both_model">
                                                    <span class="form-check-label">
