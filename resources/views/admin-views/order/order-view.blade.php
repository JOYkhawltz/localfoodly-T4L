                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    {{-- @if ($order->order_status != 'refunded' || $order->order_status != 'refund_requested' || $order->order_status != 'refund_request_canceled') --}}
                                    ...
                                    @if (isset($order->restaurant) && $order['order_type'] != 'take_away' &&  !$order->delivery_man && ($order->restaurant->restaurant_model == 'commission'
